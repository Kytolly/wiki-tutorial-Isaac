...
![官方 physics 帧率 / 每秒步数示例](assets/images/isaac_sim_frame_rate.png)

> 图 2 官方 physics 帧率与每秒步数示例（来源：<https://docs.isaacsim.omniverse.nvidia.com/latest/physics/simulation_fundamentals.html>，访问于 2026-09-01）
