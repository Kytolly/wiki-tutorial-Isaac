...
- **通道状态摘要**：FL/RL 通道已完成基础旋向定性；PCA7（`RR_Inner_Servo`）存在持续上抬失控硬件故障（`E-CAL-001#P04`），整机标定处于阻断状态，待检修后复测。
...
- **实机通道动作隔离与 ch7 故障记录**：[`E-CAL-001#P01-P03`](../../../docs/evidence/E-CAL-001-实机执行器单通道动作隔离与故障阻断记录.md)
