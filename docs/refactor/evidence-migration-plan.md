...
|---|---|---|---|
| **E-DOC-001** | 遥控器与接收机原厂操作与接线指南 | `遥控器对频说明.docx` | `P01`: 接收机引脚线序与供电极性<br>`P02`: 10秒通断电三次对频时序与LED状态机<br>`P03`: 遥控器开机安全位姿约束（左摇杆与拨杆置底） |
| **E-DOC-002** | 机器人实机出厂组装与布线规程 | `1整机安装.pdf`<br>`2接线文档.pdf` | `P01`: 动力总线与驱动板物理布局<br>`P02`: 舵机插头机械走线与限位间隙<br>`P03`: 电池仓电气接入规程 |
