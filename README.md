...
- `page/` — Wiki 页面（Markdown），按分级分类到 `intro/`、`setup/`、`train/`、`build/`、`deploy/` 子目录；根下保留 `Home.md`、`_Sidebar.md`、`_META.md`、`_Footer.md` 以兼容 GitHub Wiki；`page/assets/images/` 存放本地化配图。
- `plugin/` — 插件（规划中）。
